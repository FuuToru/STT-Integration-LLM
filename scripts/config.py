...
class ModelConfig:
    ...
    normalize: Optional[bool] = field(default=False, metadata={
        "help": "whether input is normalized, used for models such as whisper"
    })
    encoder_type: str = field(default="finetune", metadata={
        "help": "whether model is only pretrained or finetuned"
    })
...
class DataConfig:
    ...
    file: str = "src/datasets/speech_dataset.py:get_speech_dataset"
    ...
    normalize: Optional[bool] = field(default=False, metadata={
        "help": "whether input is normalized"
    })
...
class FSDPConfig:
    ...
    sharding_strategy: ShardingStrategy = ShardingStrategy.FULL_SHARD #ShardingStrategy.NO_SHARD #MZY: set NO_SHARD when use DDP
