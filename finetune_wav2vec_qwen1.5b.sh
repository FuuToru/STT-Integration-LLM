...
train_data_path=/kaggle/input/vivos-train-augument/vivos_train_augmented.jsonl
...
++train_config.total_steps=85720  \
...
++log_config.wandb_exp_name=wav2vec-qwen1.5b_$(date +"%Y%m%d") \
